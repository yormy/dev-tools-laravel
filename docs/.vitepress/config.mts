...
export default defineConfig({
    title: "dev-tools-laravel",
    description: "",
    base: '/dev-tools-laravel/',
    head: [
    ...
    themeConfig: {
        ...
        nav: [
          { text: 'Home', link: '/' },
          { text: 'Guide', link: '/v1/introduction/what-is-dev-tools' },
        ],
        ...
        sidebar: [
            {
                text: 'Introduction',
                items: [
                    { text: 'What is Guidelines', link: '/v1/introduction/what-is-dev-tools' },
                ]
            },
        ...
        socialLinks: [
            { icon: 'github', link: 'https://github.com/yormy/dev-tools-laravel' }
        ]
      }
